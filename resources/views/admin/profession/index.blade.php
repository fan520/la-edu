...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 专业管理 <span
            class="c-gray en">&gt;</span> 专业列表 <a class="btn btn-success radius r"
...
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax"
               class="input-text Wdate" style="width:120px;">
        <input type="text" class="input-text" style="width:250px" placeholder="输入专业名称..." id="search_brand_name"
               name="">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="brandDel()"
                    ...
                    href="javascript:;" onclick="brand_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加专业</a></span>
    </div>
    <div class="mt-20">
...
//                    console.log(data);
    ...
    function brand_add() {
        var title = "添加专业";//弹窗标题
        var url = "{{ url('admin/profession/add') }}";//弹窗的地址
        var h = "600";//弹窗高度
        var w = "800";//弹窗宽度
    ...
    function brand_edit(id) {
        var title = "修改专业";//弹窗标题
        var url = "{{ url('admin/profession/edit') }}/" + id;//弹窗的地址
        var h = "510";//弹窗高度
        var w = "800";//弹窗宽度
        layer_show(title, url, w, h);
    }
