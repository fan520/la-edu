...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text" autocomplete="off" value="" placeholder="不写表示不修改" id="password"
                       name="password">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="gender" type="radio" id="sex-1" value="1" @if($edit->gender==1) checked @endif>
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="gender" value="2" @if($edit->gender==2) checked @endif>
                    <label for="sex-2">女</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="gender" value="3" @if($edit->gender==3) checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text" value="{{ $edit->mobile }}" placeholder="" id="mobile"
                       name="mobile">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8">
                <input type="text" class="input-text" placeholder="" name="email" id="email" value="{{ $edit->email }}">
            </div>
        </div>
        <div class="row cl">
                    ...
                    <div id="fileList" class="uploader-list">
                        @if($edit->avatar)
                            <div  class="file-item thumbnail">
                                <img src="{{ $edit->avatar }}" style="width:150px;height:150px;">
                                <div class="info" id="upload_res"></div>
                            </div>
                        @endif
                    </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-8 skin-minimal">
                <div class="radio-box">
                    <input name="type" type="radio" id="sex-1" value="1" @if($edit->type==1) checked @endif>
                    <label for="sex-1">学生</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="type" value="2" @if($edit->type==2) checked @endif>
    ...
    $(function () {
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "{{ url('admin/member/edit') }}/{{ $edit->id }}",
