    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($Protype_name = $request->get('brand_name')) {
                $query->where('course_name', 'LIKE', '%' . $Protype_name . '%');
            }
            $data = $query->leftjoin('profession','profession.id','=','course.profession_id')->select('course.*','profession.pro_name')->offset($offset)->limit($pagesize)->get()->toArray();
